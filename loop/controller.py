...
from generate.graph import edge_table, graph_metrics, population_graph
...
from generate.population import SIM_START, Population, build_population, entities_frame
from generate.prevalence import campaign_budget, enforce_caps, subsample_campaign
from generate.red_agent.constraints import Proposal, partition_valid, set_population_account_count
from generate.red_agent.offline_search import search_offline
...
from registry.coverage import coverage_for_run
from registry.loader import load_vectors
...
def propose_or_search(
    ...
    if context.config.red_agent_mode == "live":
        from generate.red_agent.client import propose
