...
from backend.generate.injectors.agentic_injection import CartInjectionCampaign
from backend.generate.injectors.agentic_replay import AgentImpersonationCampaign, MandateReplayCampaign
from backend.generate.injectors.agentic_scope import MandateScopeBreachCampaign
from backend.generate.injectors.app_mule import (
    AppScamCampaign,
    CollectRequestAbuseCampaign,
    MuleNetworkCampaign,
)
from backend.generate.injectors.base import Campaign, Injector
from backend.generate.injectors.enumeration import BinAttackCampaign, EnumerationCampaign
from backend.generate.injectors.evasion import ScorerEvasionCampaign
from backend.generate.injectors.sca_gap import CrossBorderScaGapCampaign
from backend.generate.injectors.synthetic_id import SyntheticIdentityRingCampaign
